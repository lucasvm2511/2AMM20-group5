...
def main():
    ...
    uncompressed_state_dict = fit(config_path, uncompressed_path, compressed_path, rgb=True)
    fp_quantized_state_dict = quantize(config_path, uncompressed_path, uncompressed_state_dict, rgb=True)
